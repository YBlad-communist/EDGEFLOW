...
export default function TeacherProfileForm() {
  ...
  useEffect(() => {
    ...
    if (p) {
      setForm({
        fullName: p.fullName || "", education: p.education || "", experience: p.experience || 0,
        specialization: p.specialization || "", hourlyRate: p.hourlyRate || 0,
        bio: p.bio || "", certificateUrls: p.certificateUrls || [],
      });
    }
  }, [user, navigate]);
