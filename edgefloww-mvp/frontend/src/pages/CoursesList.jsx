...
export default function CoursesList({ user }) {
  ...
  return (
    <div className="container animate-in">
      <h1 style={{ marginBottom: 20 }}>Explore Courses</h1>

      <div className="flex gap-4 mb-4" style={{ flexWrap: "wrap" }}>
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search courses..." style={{ flex: 1, minWidth: 200 }} />
      ...
      {courses.length === 0 && <div className="empty-state"><h2>📚</h2><p>No courses found</p></div>}
